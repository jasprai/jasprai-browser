...
const SidePanel = () => {
  ...
  return (
    <div className="side-panel-container">
      ...
      <div className="side-panel-blob blob-1"></div>
      <div className="side-panel-blob blob-2"></div>
      <div className="beam-container">
        <div className="beam"></div>
      </div>

      <div
        className={`flex h-screen flex-col overflow-hidden border-x ${isDarkMode ? 'border-glass-border' : 'border-purple-100'} relative z-10`}>
        <header className="header relative">
          <div className="header-logo">
            {showHistory ? (
              <button
                ...
                className={`${isDarkMode ? 'text-purple-400 hover:text-purple-300' : 'text-purple-400 hover:text-purple-500'} cursor-pointer`}
          ...
          <div className="header-icons">
            ...
            <a
              href="https://x.com/jaspraibrowser"
              target="_blank"
              rel="noopener noreferrer"
              className={`header-icon ${isDarkMode ? 'text-purple-400 hover:text-purple-300' : 'text-purple-400 hover:text-purple-500'} cursor-pointer`}
              aria-label="Follow JasprAi on X">
              <img src="/side-panel/x-logo-white.png" alt="X" style={{ width: 26, height: 26, display: 'block' }} />
            </a>
            <button
              type="button"
        ...
        {showHistory ? (
          ...
          <>
            ...
            {hasConfiguredModels === null && (
              <div
                className={`flex flex-1 items-center justify-center p-8 ${isDarkMode ? 'text-purple-300' : 'text-purple-600'}`}>
                <div className="text-center">
                  <div className="mx-auto mb-4 size-8 animate-spin rounded-full border-2 border-purple-400 border-t-transparent"></div>
            ...
            {hasConfiguredModels === false && (
              <div
                ...
                <div className="max-w-md text-center">
                  <img src="/icon-128.png" alt="JasprAi Logo" className="mx-auto mb-4 size-12" />
                  <h3 className={`mb-2 text-lg font-semibold ${isDarkMode ? 'text-purple-200' : 'text-purple-700'}`}>
                    {t('welcome_title')}
                  </h3>
                  ...
                  <div className="mt-4 text-sm opacity-75">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`${isDarkMode ? 'text-purple-400 hover:text-purple-300' : 'text-purple-700 hover:text-purple-600'}`}>
            ...
            {hasConfiguredModels === true && (
              <>
                {messages.length === 0 && (
                  <>
                    <div
                      className={`border-t ${isDarkMode ? 'border-purple-900' : 'border-purple-100'} mb-2 p-2 shadow-sm backdrop-blur-sm`}>
                      <ChatInput
